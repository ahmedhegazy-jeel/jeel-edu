...
export default function CreateUnitPage({ params }: { params: { id: string } }) {
  ...
  const [formData, setFormData] = useState({
    ...
    icon: '',
    status: 'DRAFT',
    curriculumId: parseInt(params.id),
  });
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Create a new unit for: <span className="font-semibold">{curriculum?.name}</span>
              </p>
            </div>
            <Link
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Give your unit a clear, descriptive name
              </p>
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                placeholder="unit-intro.mp3 (optional)"
                value={formData.audioName}
                onChange={(e) => setFormData({ ...formData, audioName: e.target.value })}
              />
              <p className="mt-1 text-xs text-gray-500">
                Reference to the audio file for this unit (if available)
              </p>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>After creating the unit, you can:</p>
                    <ul className="list-disc ml-5 mt-2 space-y-1">
                      <li>Add Lessons to this unit</li>
                      <li>Each lesson can contain multiple activities</li>
                      <li>Organize content in a logical learning sequence</li>
                    </ul>
                  </div>
                </div>
              </div>
