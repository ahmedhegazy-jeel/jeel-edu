...
export default function CreateInteractiveActivityPage({ params }: { params: { id: string } }) {
      ...
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">🎮 Create Interactive Activity</h1>
        ...
        <div className="mt-8 bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g., Match the Arabic Letters Game"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="e.g., Game, Interactive"
                    value={formData.tag}
            ...
            <div className="pt-6 border-t">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">External Activity</h2>
              <div className="space-y-6">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        Interactive activities link to external educational games, simulations, or interactive tools. These can be:
                      </p>
                      <ul className="list-disc ml-5 mt-2 text-sm text-blue-700">
                        <li>Educational games (e.g., H5P, Kahoot)</li>
                        <li>Interactive simulations</li>
                        <li>Virtual labs</li>
                        <li>Custom interactive content</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="https://example.com/interactive-game"
                    value={formData.externalActivityURL}
                    onChange={(e) => setFormData({ ...formData, externalActivityURL: e.target.value })}
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    URL to the external interactive activity or game
                  </p>
                </div>
            ...
            <div className="pt-6 border-t flex justify-end space-x-4">
              ...
              >
                {loading ? 'Creating...' : '✓ Create Interactive Activity'}
              </button>
            </div>
          </form>
        </div>
