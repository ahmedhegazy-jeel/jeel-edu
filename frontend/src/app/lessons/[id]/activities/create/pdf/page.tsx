...
export default function CreatePdfActivityPage({ params }: { params: { id: string } }) {
      ...
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">📑 Create PDF Activity</h1>
        ...
        <div className="mt-8 bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g., Arabic Grammar Rules PDF"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="e.g., Grammar, Reading"
                    value={formData.tag}
            ...
            <div className="pt-6 border-t">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">PDF Content</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    URL to the PDF file (hosted on cloud storage or CDN)
                  </p>
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">PDF Audio Narration</label>
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="pdf-explanation.mp3"
                    value={formData.audioOfPDF}
                    onChange={(e) => setFormData({ ...formData, audioOfPDF: e.target.value })}
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Optional audio explanation of the PDF content
                  </p>
                </div>
            ...
            <div className="pt-6 border-t flex justify-end space-x-4">
              ...
              >
                {loading ? 'Creating...' : '✓ Create PDF Activity'}
              </button>
            </div>
          </form>
        </div>
