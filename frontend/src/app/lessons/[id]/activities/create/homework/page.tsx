...
export default function CreateHomeworkActivityPage({ params }: { params: { id: string } }) {
  ...
  const addFile = () => {
    if (fileInput.trim()) {
      setFormData({
        ...formData,
        homeworkFiles: [...formData.homeworkFiles, fileInput.trim()],
      });
      setFileInput('');
    }
  };
  ...
  const removeFile = (index: number) => {
    setFormData({
      ...formData,
      homeworkFiles: formData.homeworkFiles.filter((_, i) => i !== index),
    });
  };
      ...
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Homework Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g., Arabic Writing Practice"
            ...
            <div className="pt-6 border-t">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Homework Files</h2>
              <div className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-700">
                    📎 Add reference files, worksheets, or instructions that students should download for this homework
                  </p>
                </div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="https://example.com/homework-worksheet.pdf"
                    value={fileInput}
                ...
                {formData.homeworkFiles.length > 0 && (
                  <div className="space-y-2">
                    <p className="text-sm font-medium text-gray-700">
                      Attached Files ({formData.homeworkFiles.length})
                    </p>
                    {formData.homeworkFiles.map((file, index) => (
                      <div
                        key={index}
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-yellow-900">Homework Submission</h3>
                  <p className="text-sm text-yellow-700 mt-1">
                    Students will be able to upload their completed homework files. Teachers can review and grade submissions through the admin panel.
                  </p>
                </div>
              </div>
            </div>
