...
export default function CreateAudioActivityPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.audioWithMusic && !formData.audioWithoutMusic) {
      setError('Please provide at least one audio file');
      return;
    }
      ...
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">🔊 Create Audio Activity</h1>
        ...
        <div className="mt-8 bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g., Pronunciation Practice Audio"
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    rows={3}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="Describe the audio lesson..."
                    value={formData.desc}
            ...
            <div className="pt-6 border-t">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Audio Files</h2>
              <div className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-700">
                    💡 Provide at least one audio version. Students can choose their preferred version.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="audio-with-music.mp3"
                    value={formData.audioWithMusic}
                    onChange={(e) => setFormData({ ...formData, audioWithMusic: e.target.value })}
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Audio file with background music for engaging learning
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="audio-clean.mp3"
                    value={formData.audioWithoutMusic}
                    onChange={(e) => setFormData({ ...formData, audioWithoutMusic: e.target.value })}
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Clean audio without music for focused listening
                  </p>
                </div>
            ...
            <div className="pt-6 border-t flex justify-end space-x-4">
              ...
              >
                {loading ? 'Creating...' : '✓ Create Audio Activity'}
              </button>
            </div>
          </form>
        </div>
