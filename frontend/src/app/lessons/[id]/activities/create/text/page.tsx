...
export default function CreateTextActivityPage({ params }: { params: { id: string } }) {
        ...
        <div className="mt-8 bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="e.g., Alphabet, Vocabulary"
                    value={formData.tag}
            ...
            <div className="pt-6 border-t">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Text Content</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Enter the text content that students will read..."
                    value={formData.text}
                    onChange={(e) => setFormData({ ...formData, text: e.target.value })}
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    This is the main text content that will be displayed to students
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="text-content-audio.mp3"
                    value={formData.textAudio}
                    onChange={(e) => setFormData({ ...formData, textAudio: e.target.value })}
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Optional audio narration of the text content
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Optional audio narration of the title
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t flex justify-end space-x-4">
              ...
              >
                {loading ? 'Creating...' : '✓ Create Text Activity'}
              </button>
            </div>
          </form>
        </div>
