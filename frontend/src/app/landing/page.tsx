                           ...
                           {/* <!-- HEADER --> */}
                            <header className="bg-white shadow-sm sticky top-0 z-50">
                                ...
                                <div className="flex items-center space-x-3">
                                    <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold">Jeel</div>
                                    <span className="text-xl font-semibold">JEEL Kids Learn Hub</span>
                                </div>
                                <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
                                    ...
                                    <a href="#login" className="px-4 py-2 border rounded-lg hover:bg-blue-600 hover:text-white transition">Login</a>
                                </nav>
                                </div>
                            </header>
                            ...
                            <section id="home" className="relative bg-[url('/images/hero_bg_with_char.png')] bg-cover bg-center">
                                <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-10 items-center">  
                                    <div>
                                        ...
                                        <a href="#curriculum" className="px-6 py-3 bg-[#FF9F67] text-blue-700 font-semibold rounded-lg shadow hover:bg-blue-50">Get Started</a>
                                        <a href="#demo" className="px-6 py-3 border border-white/70 rounded-lg hover:bg-white hover:text-blue-700 transition">For Schools</a>
                                        </div>
                                    </div>
                                ...
                                {/*<div className="absolute bottom-0 left-0 right-0">
                                    ...
                                    <path fill="#fff" d="M0,96L80,101.3C160,107,320,117,480,106.7C640,96,800,64,960,53.3C1120,43,1280,53,1360,58.7L1440,64V120H0Z"/></svg>
                                </div>*/}
                                
                                <div className="absolute bottom-0 left-0 w-full opacity-20">
                                        <svg viewBox="0 0 1440 300" xmlns="http://www.w3.org/2000/svg">
                                            <path fill="#ffffff" d="M0,192L48,176C96,160,192,128,288,144C384,160,480,224,576,245.3C672,267,768,245,864,218.7C960,192,1056,160,1152,160C1248,160,1344,192,1392,208L1440,224V320H0Z"></path>
                                        </svg>
                                </div>
                            ...
                            <Marquee  arr={['Thoughtful/motivating reward system',
                                            ...
                                            'Plan, assign, and track progress through simple dashboards',
                                            'Stay involved through detailed progress reports and personalized recommendations']} icons={['🎮', '📚', '🎧', '🎥', '🎲', '🎯']} />
